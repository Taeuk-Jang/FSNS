    ...
    for beta in beta_list:
        for lr in lr_list:
            for alpha in alpha_list:
                    config = '{}/{}_non_pca_min_self_pace  lr : {:.5f}, beta : {}, alpha : {}'.format(data_name, sens_attr, lr, beta, alpha)
                    print(beta)
                    print(lr)
                    print(alpha)
                    print(alpha)
                    ...
                    for epoch in tqdm(range(epochs)):
                        ...
                        if max_used < used/total:
                            max_used = used/total
                        if used/total <= max_used - 0.1:
                            max_used = 0
                            alpha += 0.2
                            print('alpha updated, current alpha : {}'.format(alpha))
